...
class InvoiceSettings {
  ...
  factory InvoiceSettings.fromJson(Map<String, dynamic> j) => InvoiceSettings(
        ...
        accentColor: j['accentColor'] ?? 0xFF1E50D8,
        showLogo: j['showLogo'] ?? true,
        showSellerDetails: j['showSellerDetails'] ?? true,
        showAmountInWords: j['showAmountInWords'] ?? true,
        showTaxSummary: j['showTaxSummary'] ?? true,
        showDeclaration: j['showDeclaration'] ?? true,
        showBankDetails: j['showBankDetails'] ?? true,
        showSignature: j['showSignature'] ?? true,
  ...
  InvoiceSettings copyWith({
    ...
    String? footerText,
      ...
      InvoiceSettings(
        gstYear: gstYear ?? this.gstYear,
        gstCounter: gstCounter ?? this.gstCounter,
        nonGstPrefix: nonGstPrefix ?? this.nonGstPrefix,
        nonGstCounter: nonGstCounter ?? this.nonGstCounter,
        template: template ?? this.template,
        accentColor: accentColor ?? this.accentColor,
        showLogo: showLogo ?? this.showLogo,
        showSellerDetails: showSellerDetails ?? this.showSellerDetails,
