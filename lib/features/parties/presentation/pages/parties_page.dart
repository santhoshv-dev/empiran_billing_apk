...
class _PartiesPageState extends State<PartiesPage> {
  ...
  Widget build(BuildContext context) {
    return PageFrame(
      ...
      subtitle:
          'Manage client accounts, vendor contacts, and running balances.',
                  ...
                  final segmentedFilter = SingleChildScrollView(
                    ...
                    child: SegmentedButton<String>(
                      segments: const [
                        ...
                        ButtonSegment(
                            value: 'Customers', label: Text('Customers')),
                        ButtonSegment(
                            value: 'Suppliers', label: Text('Suppliers')),
                      ],
                      selected: {_filter},
              ...
              Expanded(
                child: loaded.filteredParties.isEmpty
                    ? EmpiranEmptyState(
                        ...
                        description:
                            'Add your clients or suppliers to assign invoices and track payments.',
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        icon: const Icon(Icons.edit_outlined,
                                            size: 20),
                                        onPressed: () =>
                                            showPartyDialog(context, party: p),
                                      ),
                                      IconButton(
                                        tooltip: 'Delete Contact',
