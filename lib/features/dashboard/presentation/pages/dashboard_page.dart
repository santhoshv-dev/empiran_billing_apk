                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(t.number, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                                        Text('${t.partyName.isNotEmpty ? t.partyName : 'Cash Customer'} • ${Formatters.date(t.date)}',
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text('Stock Alerts', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                          TextButton(
