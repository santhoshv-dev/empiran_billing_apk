...
class _ProductsPageState extends State<ProductsPage> {
  ...
  Widget _buildCategoryCard(String cat, int count, bool isSelected) {
    ...
    return InkWell(
      ...
      onLongPress: cat == 'All' ? null : () => _editCategoryDialog(context, cat),
              ...
              children: [
                Container(
                  ...
                  child: imageBytes != null
                      ...
                      : Icon(
                          cat == 'All' ? Icons.apps_rounded : Icons.category_rounded,
              ...
              Positioned(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.edit_outlined, size: 11, color: AppColors.primary),
                  ),
                ),
              ),
          ],
  ...
  void _confirmDeleteProduct(BuildContext context, Item item) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete "${item.name}"? This action will remove the item from catalog.'),
        actions: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      // Sales Details Card
                      const Text('Sales & Pricing Details', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              children: [
                                const Text('Sales Price', style: TextStyle(fontSize: 12, color: Colors.grey)),
                                const SizedBox(height: 4),
                                Text(
                            ...
                            if (canViewCost)
                              Column(
                                children: [
                                  const Text('Cost / Purchase', style: TextStyle(fontSize: 12, color: Colors.grey)),
                                  const SizedBox(height: 4),
                                  Text(
                            ...
                            Column(
                              children: [
                                const Text('Unit of Measure', style: TextStyle(fontSize: 12, color: Colors.grey)),
                                const SizedBox(height: 4),
                                Text(
                                  item.unit,
                                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
                      ...
                      if (!item.isService) ...[
                        const Text('Inventory & Stock Status', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                        const SizedBox(height: 10),
                        Container(
                          padding: const EdgeInsets.all(14),
                          decoration: BoxDecoration(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    isOut ? 'Out of Stock' : isLowStock ? 'Low Stock Warning' : 'Healthy Stock Level',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: isOut ? AppColors.error : isLowStock ? AppColors.warning : AppColors.success,
                                    ),
                                  ),
                                  const SizedBox(height: 2),
                                  Text(
        ...
        builder: (context, setDialogState) => AlertDialog(
          title: Row(
            children: [
              ...
              Expanded(
                child: Text('Edit Category: $category', overflow: TextOverflow.ellipsis),
              ),
            ],
          ),
          content: ConstrainedBox(
              ...
              onPressed: () async {
                final confirm = await showDialog<bool>(
                  ...
                  builder: (dCtx) => AlertDialog(
                    ...
                    content: Text('Are you sure you want to delete category "$category"? Products in this category will remain intact.'),
                    actions: [
              ...
              onPressed: () async {
                ...
                settingsBloc.add(
                  UpdateCategoryRequested(
                    oldName: category,
                    newName: newName,
                    imageBase64: imageModified ? imageBase64 : _categoryImages[category],
                  ),
                );
                ...
                if (category.toLowerCase() != newName.toLowerCase()) {
                  ...
                  if (pState is ProductsLoaded) {
                    ...
                    for (final item in pState.items) {
                      if (item.category.trim().toLowerCase() == category.toLowerCase()) {
                            ...
                            children: [
                              ...
                              if (_selectedCategory != 'All') ...[
                                ...
                                EmpiranButton(
                                  ...
                                  icon: Icons.edit_outlined,
                                  variant: EmpiranButtonVariant.outlined,
                                  onPressed: () => _editCategoryDialog(context, _selectedCategory),
                                ),
                              ],
                              const SizedBox(width: 10),
                              EmpiranButton(
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, idx) {
                        ...
                        final count = cat == 'All'
                            ? loaded.items.length
                            : loaded.items.where((x) => x.category.toLowerCase() == cat.toLowerCase()).length;
                        return _buildCategoryCard(cat, count, _selectedCategory == cat);
                      },
                    ),
                  ),
                                ...
                                builder: (context, cardConstraints) {
                                  ...
                                  final actions = [
                                    if (!item.isService) ...[
                                      IconButton(
                                        ...
                                        onPressed: () => showStockHistoryDialog(context, item),
                                      ),
                                      IconButton(
                                        tooltip: 'Add Stock',
                                    ...
                                    if (canManage) ...[
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () => _confirmDeleteProduct(context, item),
                                      ),
                                    ],
                                  ];
                                  ...
                                  if (isCardCompact) {
                                    return EmpiranCard(
                                      ...
                                      child: InkWell(
                                        onTap: () => _showProductDetailsSheet(context, item, canManage, canViewCost),
                                        borderRadius: BorderRadius.circular(AppRadii.medium),
                                        child: Padding(
